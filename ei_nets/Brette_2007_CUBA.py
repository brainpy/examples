...
class CUBA(bp.dyn.Network):
  def __init__(self, scale=1.0, method='exp_auto'):
    ...
    E2E = bp.models.ExpCUBA(E, E, bp.conn.FixedProb(0.02), g_max=we, tau=5., method=method)
    E2I = bp.models.ExpCUBA(E, I, bp.conn.FixedProb(0.02), g_max=we, tau=5., method=method)
    I2E = bp.models.ExpCUBA(I, E, bp.conn.FixedProb(0.02), g_max=wi, tau=10., method=method)
    I2I = bp.models.ExpCUBA(I, I, bp.conn.FixedProb(0.02), g_max=wi, tau=10., method=method)
